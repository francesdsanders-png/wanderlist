...
function mapsUrl(location, distance) {
...
function TagPill({ label, emoji, active, onClick }) {
  return (
    <button onClick={onClick} style={{ display: "inline-flex", alignItems: "center", gap: 4, padding: "5px 12px", borderRadius: 999, border: active ? `1.5px solid ${C.blue}` : `1.5px solid ${C.border}`, background: active ? C.blueLight : C.surface, color: active ? C.blue : C.textSub, fontSize: 12, cursor: "pointer", fontFamily: font, fontWeight: active ? 600 : 400, transition: "all 0.15s", whiteSpace: "nowrap" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 4 }}>
        <div style={{ flex: 1, paddingRight: 8 }}>
          ...
          {(place.location || place.distance) && (
            <a href={place.location ? mapsUrl(place.location) : "#"} target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: 12, color: C.blue, marginTop: 3, fontFamily: font, fontWeight: 500, textDecoration: "none" }}>
